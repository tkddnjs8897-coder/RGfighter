...
const CHARACTERS = [
  {
    ...
    poseSprites: {
      punch1: { src: 'assets/characters/yang2_punch1.png', dir: 1 },
      ...
      block: { src: 'assets/characters/yang2_block.png', dir: 1 },
      ...
      special3: { src: 'assets/characters/yang2_special3.png', dir: 1 },
    ...
    moves: {
      ...
      specials: [
        ...
        {
          key: 'special3', name: '편의점 음식 먹고 회복', type: 'heal',
  ...
  },
  {
    ...
    poseSprites: {
      punch1: { src: 'assets/characters/gura2_punch1.png', dir: 1 },
    ...
    moves: {
      ...
      specials: [
        {
          key: 'special1', name: '법의 심판', type: 'dash',
          damage: 18, range: 140,
          startup: 12, active: 6, recovery: 18,
          gaugeCost: 35, color: '#c9a227'
        },
        {
          key: 'special2', name: '정치쑈', type: 'burst', ignoreFacing: true,
          damage: 14, range: 999,
          startup: 20, active: 10, recovery: 22,
          gaugeCost: 40, color: '#d63b3b'
        },
        {
          key: 'special3', name: '보험사기', type: 'counter',
